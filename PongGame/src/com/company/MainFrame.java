...
public class MainFrame extends JFrame implements KeyListener,Runnable {
    ...
    private javax.swing.JLabel text,text1;
    ...
    private void addLayoutSuggest() {

        text = new javax.swing.JLabel();
        text.setText("Hướng dẫn: \n Người 1: Nhấn phím s để tạo server \n Người 2 : Nhấn phím C để kết nối");
	...
	// write your code here
        ...
        try {
            image = ImageIO.read(new File("C:\\Users\\thuong\\Desktop\\PongGame\\PongGame\\src\\pingpong.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        // - Set background texture of main menu - //
        MainFrame newT = new MainFrame();
        newT.run();
    }
//    }
    ...
    public void keyPressed(KeyEvent arg0) {
        ...
        if(keyCode==KeyEvent.VK_S){
            ...
            portAdd = JOptionPane.showInputDialog(null, "Enter server port:", 1);
            ...
            if(portAdd!=null){
                if(!isPort(portAdd)){
                    ...
                    servername = JOptionPane.showInputDialog(null, "Player name:", "Enter server name:", 1);
                    servername+="";
        ...
        if(keyCode==KeyEvent.VK_C){
            ...
            ipAdd = JOptionPane.showInputDialog(null, "Enter server ip:", 1);
            ...
            if(ipAdd!=null){
                ...
                if(!isIPAddress(ipAdd)){
                    ...
                    portAdd = JOptionPane.showInputDialog(null, "Enter server port number:", 1);
                    ...
                    if(portAdd!=null){
                        ...
                        // - Input Dialog for get a nick name for client player - //
                            ...
                            clientname = JOptionPane.showInputDialog(null, "Player name:", "Enter server name:", 1);
                            clientname += "";
